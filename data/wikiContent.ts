...
export const getWikiCategories = (lang: LanguageCode): WikiCategory[] => [
  {
    id: 'daily_life',
    title: getLocalizedTitle('life', lang), // Using 'life' title key or custom Vantaa title
    icon: 'Bus',
    theme: { border: 'border-cyan-200', text: 'text-cyan-700', hoverBg: 'bg-cyan-50', shadow: 'shadow-cyan-200' },
    subsections: [
        {
            title: 'Vantaa Essentials',
            articles: [
                { id: 'vantaa_ring_rail', icon: 'Train', tags: ['vantaa', 'transport', 'housing'], ...getLocalizedArticle('vantaa_ring_rail', lang) },
                { id: 'vantaa_multicultural', icon: 'Globe', tags: ['vantaa', 'culture', 'family'], ...getLocalizedArticle('vantaa_multicultural', lang) },
                { id: 'vantaa_library_tikkurila', icon: 'Printer', tags: ['life', 'hobbies', 'family', 'vantaa'], ...getLocalizedArticle('vantaa_library_tikkurila', lang) },
                { id: 'daily_transport', icon: 'Bus', tags: ['arrival', 'life', 'vantaa'], ...getLocalizedArticle('daily_transport', lang) },
                { id: 'daily_groceries', icon: 'ShoppingBag', tags: ['life', 'food'], ...getLocalizedArticle('daily_groceries', lang) },
                { id: 'daily_pantti', icon: 'Recycle', tags: ['life', 'environment'], ...getLocalizedArticle('daily_pantti', lang) }
            ]
        }
    ]
  },
    ...
    subsections: [
        {
            ...
            articles: [
                ...
                { id: 'vantaa_info_points', icon: 'Info', tags: ['vantaa', 'help', 'bureaucracy'], ...getLocalizedArticle('vantaa_info_points', lang) },
  ...
  {
    id: 'nature',
    title: getLocalizedTitle('nature', lang) || 'Nature',
    icon: 'TreePine',
    ...
    subsections: [
        {
            title: 'Outdoor Life',
            articles: [
                { id: 'vantaa_nature', icon: 'TreePine', tags: ['nature', 'vantaa', 'wellness'], ...getLocalizedArticle('vantaa_nature', lang) },
                { id: 'nature_everyman', icon: 'Map', tags: ['nature', 'legal'], ...getLocalizedArticle('nature_everyman', lang) },
                { id: 'nature_winter', icon: 'Snowflake', tags: ['nature', 'health'], ...getLocalizedArticle('nature_winter', lang) },
    ...
    subsections: [
        {
            ...
            articles: [
                { id: 'vantaa_aviapolis', icon: 'Plane', tags: ['work', 'vantaa', 'logistics', 'tech'], ...getLocalizedArticle('vantaa_aviapolis', lang) },
