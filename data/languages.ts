...
export const TRANSLATIONS: Record<LanguageCode, Partial<Record<TranslationKey, string>>> = {
  en: {
    ...
    landing_btn_quiz: "Take the short quiz",
    landing_btn_ask: "Ask a question",
  ...
  vi: {
    ...
    landing_btn_quiz: "Làm bài trắc nghiệm ngắn",
    landing_btn_ask: "Đặt câu hỏi",
  ...
  "pt-br": {
    ...
    landing_btn_quiz: "Faça o teste rápido",
    landing_btn_ask: "Faça uma pergunta",
    ...
    dash_btn_ask: "Faça uma pergunta",
  ...
  ru: {
    ...
    landing_btn_quiz: "Пройти короткий тест",
    landing_btn_ask: "Задать вопрос",
