...
export const es: TranslationResource = {
  ...
  wiki: {
    titles: {
      ...
      job_cover_letter: 'Carta de Presentación', job_interview: 'Entrevista', net_linkedin: 'Consejos de LinkedIn', job_recognition: 'Reconocimiento de Títulos', job_cv_tips: 'CV Finlandés',
    ...
    articles: {
      ...
      'net_linkedin': { title: 'LinkedIn', summary: 'Tu CV digital.', content: `# LinkedIn 🔗\n\nMantenlo actualizado. Usa la ubicación "Finlandia".` },
