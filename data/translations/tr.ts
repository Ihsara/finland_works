...
export const tr: TranslationResource = {
  ...
  wiki: {
    titles: {
      ...
      job_cover_letter: 'Ön Yazı', job_interview: 'Mülakat', job_linkedin: 'LinkedIn', job_recognition: 'Denklik', job_cv_tips: 'Finlandiya CV',
    ...
    articles: {
      ...
      'job_linkedin': { title: 'LinkedIn', summary: 'Dijital CV\'niz.', content: `# LinkedIn 🔗\n\nGüncel tut. Konumu "Finlandiya" yap.` },
