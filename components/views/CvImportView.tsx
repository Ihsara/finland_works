...
export const CvImportView: React.FC<CvImportViewProps> = ({ onBack, onProfileUpdated }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-[#0b1021] animate-in fade-in duration-500">
      <div className="px-6 py-4 border-b border-gray-100 dark:border-white/10 flex items-center bg-white/80 dark:bg-[#0b1021]/80 backdrop-blur-xl sticky top-0 z-20 justify-between">
