...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="fixed inset-0 bg-gray-100 md:flex md:items-center md:justify-center font-sans">
      ...
      */}
      <div className="w-full h-[100dvh] md:h-[90vh] md:max-w-6xl bg-white md:rounded-3xl md:shadow-2xl md:border md:border-gray-200 flex flex-col overflow-hidden relative pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] md:pt-0 md:pb-0 transition-all duration-300 ease-in-out">
        {children}
      </div>
    </div>
  );
